...
LIGHTWARE_API bool pointInPoly(lw_vec2 *vertices, unsigned num_verts, lw_vec2 point);
...
/// @param point point to test
/// @return true if point is inside of the polygon
LIGHTWARE_API bool pointInConvexPoly(lw_vec2 *vertices, unsigned num_vertices, lw_vec2 point);

LIGHTWARE_API bool intersectSegmentPlane(lw_vec3 line[2], lw_vec4 plane, float *o_t);

LIGHTWARE_API bool intersectSegmentSegment(lw_vec2 seg0[2], lw_vec2 seg1[2], float *o_t);
LIGHTWARE_API bool intersectSegmentLine(lw_vec2 seg[2], lw_vec2 line[2], float *o_t);
LIGHTWARE_API bool intersectSegmentRay(lw_vec2 line[2], lw_vec2 ray[2], float *o_t);
